...
public class InstanceRequest implements org.apache.thrift.TBase<InstanceRequest, InstanceRequest._Fields>, java.io.Serializable, Cloneable, Comparable<InstanceRequest> {
  ...
  private static final org.apache.thrift.protocol.TField LOGICAL_TABLE_ROUTE_INFO_FIELD_DESC = new org.apache.thrift.protocol.TField("logicalTableRouteInfo", org.apache.thrift.protocol.TType.LIST, (short)8);
  ...
  private @org.apache.thrift.annotation.Nullable java.util.List<TableRouteInfo> logicalTableRouteInfo; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    CID((short)7, "cid"),
    LOGICAL_TABLE_ROUTE_INFO((short)8, "logicalTableRouteInfo");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 7: // CID
          return CID;
        case 8: // LOGICAL_TABLE_ROUTE_INFO
          return LOGICAL_TABLE_ROUTE_INFO;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.SEARCH_SEGMENTS,_Fields.ENABLE_TRACE,_Fields.BROKER_ID,_Fields.OPTIONAL_SEGMENTS,_Fields.CID,_Fields.LOGICAL_TABLE_ROUTE_INFO};
  ...
  static {
    ...
    tmpMap.put(_Fields.CID, new org.apache.thrift.meta_data.FieldMetaData("cid", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.LOGICAL_TABLE_ROUTE_INFO, new org.apache.thrift.meta_data.FieldMetaData("logicalTableRouteInfo", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TableRouteInfo.class))));
  ...
  public InstanceRequest(InstanceRequest other) {
    ...
    if (other.isSetLogicalTableRouteInfo()) {
      java.util.List<TableRouteInfo> __this__logicalTableRouteInfo = new java.util.ArrayList<TableRouteInfo>(other.logicalTableRouteInfo.size());
      for (TableRouteInfo other_element : other.logicalTableRouteInfo) {
        __this__logicalTableRouteInfo.add(new TableRouteInfo(other_element));
      }
      this.logicalTableRouteInfo = __this__logicalTableRouteInfo;
    }
  }
  ...
  public void clear() {
    ...
    this.cid = null;
    this.logicalTableRouteInfo = null;
  }
  ...
  public int getLogicalTableRouteInfoSize() {
    return (this.logicalTableRouteInfo == null) ? 0 : this.logicalTableRouteInfo.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<TableRouteInfo> getLogicalTableRouteInfoIterator() {
    return (this.logicalTableRouteInfo == null) ? null : this.logicalTableRouteInfo.iterator();
  }

  public void addToLogicalTableRouteInfo(TableRouteInfo elem) {
    if (this.logicalTableRouteInfo == null) {
      this.logicalTableRouteInfo = new java.util.ArrayList<TableRouteInfo>();
    }
    this.logicalTableRouteInfo.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<TableRouteInfo> getLogicalTableRouteInfo() {
    return this.logicalTableRouteInfo;
  }

  public void setLogicalTableRouteInfo(@org.apache.thrift.annotation.Nullable java.util.List<TableRouteInfo> logicalTableRouteInfo) {
    this.logicalTableRouteInfo = logicalTableRouteInfo;
  }

  public void unsetLogicalTableRouteInfo() {
    this.logicalTableRouteInfo = null;
  }

  /** Returns true if field logicalTableRouteInfo is set (has been assigned a value) and false otherwise */
  public boolean isSetLogicalTableRouteInfo() {
    return this.logicalTableRouteInfo != null;
  }

  public void setLogicalTableRouteInfoIsSet(boolean value) {
    if (!value) {
      this.logicalTableRouteInfo = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case LOGICAL_TABLE_ROUTE_INFO:
      if (value == null) {
        unsetLogicalTableRouteInfo();
      } else {
        setLogicalTableRouteInfo((java.util.List<TableRouteInfo>)value);
      }
      break;
  ...
  public java.lang.Object getFieldValue(_Fields field) {
    ...
    case LOGICAL_TABLE_ROUTE_INFO:
      return getLogicalTableRouteInfo();
  ...
  public boolean isSet(_Fields field) {
    ...
    case CID:
      return isSetCid();
    case LOGICAL_TABLE_ROUTE_INFO:
      return isSetLogicalTableRouteInfo();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(InstanceRequest that) {
    ...
    boolean this_present_logicalTableRouteInfo = true && this.isSetLogicalTableRouteInfo();
    boolean that_present_logicalTableRouteInfo = true && that.isSetLogicalTableRouteInfo();
    if (this_present_logicalTableRouteInfo || that_present_logicalTableRouteInfo) {
      if (!(this_present_logicalTableRouteInfo && that_present_logicalTableRouteInfo))
        return false;
      if (!this.logicalTableRouteInfo.equals(that.logicalTableRouteInfo))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetLogicalTableRouteInfo()) ? 131071 : 524287);
    if (isSetLogicalTableRouteInfo())
      hashCode = hashCode * 8191 + logicalTableRouteInfo.hashCode();
  ...
  public int compareTo(InstanceRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetLogicalTableRouteInfo(), other.isSetLogicalTableRouteInfo());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetLogicalTableRouteInfo()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.logicalTableRouteInfo, other.logicalTableRouteInfo);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    ...
    if (isSetLogicalTableRouteInfo()) {
      if (!first) sb.append(", ");
      sb.append("logicalTableRouteInfo:");
      if (this.logicalTableRouteInfo == null) {
        sb.append("null");
      } else {
        sb.append(this.logicalTableRouteInfo);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class InstanceRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<InstanceRequest> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.logicalTableRouteInfo = new java.util.ArrayList<TableRouteInfo>(_list22.size);
                @org.apache.thrift.annotation.Nullable TableRouteInfo _elem23;
                for (int _i24 = 0; _i24 < _list22.size; ++_i24)
                {
                  _elem23 = new TableRouteInfo();
                  _elem23.read(iprot);
                  struct.logicalTableRouteInfo.add(_elem23);
                }
                iprot.readListEnd();
              }
              struct.setLogicalTableRouteInfoIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, InstanceRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.logicalTableRouteInfo != null) {
        if (struct.isSetLogicalTableRouteInfo()) {
          oprot.writeFieldBegin(LOGICAL_TABLE_ROUTE_INFO_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.logicalTableRouteInfo.size()));
            for (TableRouteInfo _iter27 : struct.logicalTableRouteInfo)
            {
              _iter27.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class InstanceRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<InstanceRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, InstanceRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetLogicalTableRouteInfo()) {
        {
          oprot.writeI32(struct.logicalTableRouteInfo.size());
          for (TableRouteInfo _iter30 : struct.logicalTableRouteInfo)
          {
            _iter30.write(oprot);
          }
        }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.logicalTableRouteInfo = new java.util.ArrayList<TableRouteInfo>(_list37.size);
          @org.apache.thrift.annotation.Nullable TableRouteInfo _elem38;
          for (int _i39 = 0; _i39 < _list37.size; ++_i39)
          {
            _elem38 = new TableRouteInfo();
            _elem38.read(iprot);
            struct.logicalTableRouteInfo.add(_elem38);
          }
        }
        struct.setLogicalTableRouteInfoIsSet(true);
      }
