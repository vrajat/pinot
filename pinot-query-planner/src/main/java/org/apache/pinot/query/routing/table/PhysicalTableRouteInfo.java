...
public class PhysicalTableRouteInfo {
  ...
  public static PhysicalTableRouteInfo from(String tableName, RoutingManager routingManager,
    ...
    return new PhysicalTableRouteInfo(routingTable.getServerInstanceToSegmentsMap(), tableName,
        routingTable.getUnavailableSegments(), routingTable.getNumPrunedSegments());
  }

  private PhysicalTableRouteInfo(Map<ServerInstance, ServerRouteInfo> serverRouteInfoMap, String tableName,
